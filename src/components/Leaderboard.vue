  ...
  <div class="leaderboard">
    <div class="container">
      ...
      <div class="footer">
        ...
        <button class="btn" @click="$router.push('/game')">开始游戏</button>
        ...
        <button class="btn btn-secondary" @click="$router.push('/tetris-leaderboard')">俄罗斯方块排行榜</button>
      </div>
    </div>
  </div>
</template>
